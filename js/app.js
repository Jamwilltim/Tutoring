...
function introAnimation() {
  ...
  blinkCaret = setInterval(() => {
    gsap.fromTo(
      ".typewriter-text",
      { borderColor: "transparent" },
      { borderColor: "#e9e9e9", duration: 0.1, ease: "linear" }
    );
  }, 500);
  timeline.fromTo(
    ".typewriter-text",
    { width: 0 },
    { width: "100%", duration: 2.5, ease: "steps(14)" }
  );
}
...
$(".menu-item").click(function () {
  ...
  if (oldCount > count) {
    gsap.fromTo(
      mainSections[count],
      { xPercent: -100 },
      { xPercent: 0, duration: 1.2, ease: "power1.out" }
    );
    gsap.fromTo(
      mainSections[oldCount],
      { xPercent: 0 },
      { duration: 1.2, xPercent: 100, ease: "power1.out" }
    );
    gsap.fromTo(
      descriptionSections[oldCount],
      { xPercent: 0 },
      { duration: 1.2, xPercent: 100, ease: "power1.out" }
    );
    gsap.fromTo(
      descriptionSections[count],
      { xPercent: -100 },
      { xPercent: 0, duration: 1.2, ease: "power1.out" }
    );
    ...
    gsap.fromTo(
      mainSections[count],
      { xPercent: 100 },
      { duration: 1.2, xPercent: 0, ease: "power1.out" }
    );
    gsap.fromTo(
      descriptionSections[count],
      { xPercent: 100 },
...
$(".mobile-nav").click(function () {
  ...
  if (oldCount > count) {
    gsap.fromTo(
      mainSectionsMobile[count],
      { xPercent: -100 },
      { xPercent: 0, duration: 1.2, ease: "power1.out" }
    );
    gsap.fromTo(
      mainSectionsMobile[oldCount],
      { xPercent: 0 },
      { duration: 1.2, xPercent: 100, ease: "power1.out" }
    );
    gsap.fromTo(
      descriptionSectionsMobile[oldCount],
      { xPercent: 0 },
      { duration: 1.2, xPercent: 100, ease: "power1.out" }
    );
    gsap.fromTo(
      descriptionSectionsMobile[count],
      { xPercent: -100 },
      { xPercent: 0, duration: 1.2, ease: "power1.out" }
    );
  } else if (oldCount < count) {
